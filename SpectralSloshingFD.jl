...
#baseline
#b0[1+1]=0.200407243926765;	
#b0[2+1]=0.0198164774183185;	
#b0[3+1]=0.00298128941117142;	
#b0[4+1]=0.000429810538337155;	
#b0[5+1]=4.11346689785517E-05;

#H=20
b0[1+1]=0.398393843361557;	
b0[2+1]=0.0722211231186387;	
b0[3+1]=0.0210920759594591;	
b0[4+1]=0.00787989623539052;	
b0[5+1]=0.0015594699697515;

#H=30
b0[1+1]=0.621252740420309;	
b0[2+1]=0.119189302533543;	
b0[3+1]=0.0417717767728399;	
b0[4+1]=0.0535757545585889;	
b0[5+1]=0.0171049624270248;

#shallow
b0[1+1]=0.175258308624445;	
b0[2+1]=0.0268799683402052;	
b0[3+1]=0.00565458077900323;	
b0[4+1]=0.00153021749921427;	
b0[5+1]=0.000396442100535317;
...
#H=20
q=4.21045389290768;
dt=0.00642686180724499;

#H=30
q=4.53419653080116;
dt=0.00066693678836273;

#shallow
q=1.03605332287991;
dt=0.000712870363300786;
...
for k=2:Nt #time steps
    ...
    L=fphi_+fkdR1[:,2]*dt;
    for j=2:Nf+1
        bp3[j]=bp3[j]+2/pi*dt*fkdR1[j,1];
    end
    ap3=CC1\L;     

    temp4=fkdR(ap3,bp3);    
    fkdR1[:]=temp1[:]/6+temp2[:]/3+temp3[:]/3+temp4[:]/6;
    bp4[:]=b1[:]; 
    L=fphi_+fkdR1[:,2]*dt;
    for j=2:Nf+1
        bp4[j]=bp4[j]+2/pi*dt*fkdR1[j,1];
    end
    ap4=CC1\L;   
